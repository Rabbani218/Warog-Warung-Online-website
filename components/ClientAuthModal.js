...
export default function ClientAuthModal({ isOpen, onClose }) {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      if (res.error) {
        // The error message comes from CredentialsProvider's throw
        setError(res.error);
  ...
  async function handleGoogleLogin() {
    ...
    try {
      // Google OAuth — uses redirect flow with callbackUrl back to current page
      await signIn("google", {
              ...
              <div className="p-6 md:p-10">
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-500 text-sm px-4">
                    Gunakan akun Anda untuk melanjutkan pesanan atau memberikan
                    ulasan.
                  </p>
                </div>
